  ...
  MouseMotionListener, ActionListener, ChangeListener
{
  ...
  public SandDisplay(String title, int numRows, int numCols, String[] buttonNames)
  {
    ...
    gSlider = new JSlider(JSlider.HORIZONTAL, -1, 1, 1);
    slider.addChangeListener(this);
    gSlider.addChangeListener(this);
    slider.setMajorTickSpacing(1);
    gSlider.setMajorTickSpacing(2);
    slider.setPaintTicks(true);
    gSlider.setPaintTicks(true);
    Hashtable<Integer, JLabel> labelTable = new Hashtable<Integer, JLabel>();
    Hashtable<Integer, JLabel> labelTableG = new Hashtable<Integer, JLabel>();
    labelTableG.put(new Integer(1), new JLabel("Down"));
    labelTableG.put(new Integer(-1), new JLabel("Up"));
    labelTable.put(new Integer(1), new JLabel("Slow"));
    labelTable.put(new Integer(100), new JLabel("Fast"));
    labelTable.put(new Integer(50), new JLabel("Speed Slider"));
    labelTableG.put(new Integer(0), new JLabel("Invert Slider"));
    slider.setLabelTable(labelTable);
    gSlider.setLabelTable(labelTableG);
